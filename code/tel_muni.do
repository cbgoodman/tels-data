...
import excel using ${raw}tel_muni_changes.xlsx, clear firstrow
...
sort stateabb year
save ${exports}tels_muni_changes.dta, replace

* Export to Excel File
export excel using ${exports}tels_muni_changes.xlsx, replace firstrow(varlabels)
...
sort stateabb year
save ${exports}tels_muni_state.dta, replace

* Exporting to excel spreadsheet format
export excel using ${exports}tels_muni_state.xlsx, replace firstrow(varlabels)
