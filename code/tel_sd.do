...
import excel using ${raw}tel_sd_changes.xlsx, clear firstrow
...
sort stateabb year
save ${exports}tels_sd_changes.dta, replace

* Export to Excel File
export excel using ${exports}tels_sd_changes.xlsx, replace firstrow(varlabels)
...
replace typecode=5
replace typename="School Districts"
...
sort stateabb year
save ${exports}tels_sd_state.dta, replace

* Exporting to excel spreadsheet format
export excel using ${exports}tels_sd_state.xlsx, replace firstrow(varlabels)
